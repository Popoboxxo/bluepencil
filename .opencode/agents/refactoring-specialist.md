...
permission:
  ...
  todowrite: allow
---
> **Extension:** If `.opencode/3-project/bp-refactoring-specialist-ext.md` exists → read and apply immediately.
...
2. **REQ check:** 
3. **Read context:** `.opencode/3-project/bp-refactoring-specialist-ext.md` if present.
