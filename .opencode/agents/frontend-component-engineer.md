...
3. **Read context:** `.opencode/3-project/bp-frontend-component-engineer-ext.md` if present.
...
11. **Validate:** existing tests must not break. Tests schreiben/aktualisieren — Pflicht vor Commit.
