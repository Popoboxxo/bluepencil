...
permission:
  ...
  bash: deny
---
> **Extension:** If `.opencode/3-project/bp-technical-writer-ext.md` exists → read and apply immediately.
...
2. **Read context:** `.opencode/3-project/bp-technical-writer-ext.md` if present.
