...
permission:
  ...
  todowrite: allow
---
> **Extension:** If `.opencode/3-project/bp-accessibility-specialist-ext.md` exists → read and apply immediately.
...
2. **Read context:** `.opencode/3-project/bp-accessibility-specialist-ext.md` if present.
