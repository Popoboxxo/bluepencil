...
> **Extension:** If `.claude/3-project/bp-frontend-component-engineer-ext.md` exists → read and apply immediately.
...
3. **Read context:** `.claude/3-project/bp-frontend-component-engineer-ext.md` if present.
